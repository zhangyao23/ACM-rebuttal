...
\newcommand{\sideruler}{%
  ...
  \siderulery=.38in
  \loop
    \put(\LenToUnit{-16pt},\LenToUnit{-\siderulery}){\cvprtenhv\color[rgb]{.5,.5,1}\scriptsize\ifnum\sidecount<10 00\else\ifnum\sidecount<100 0\fi\fi\number\sidecount}%
    \advance\sidecount by 52
    \put(\LenToUnit{\textwidth+20pt},\LenToUnit{-\siderulery}){\cvprtenhv\color[rgb]{.5,.5,1}\scriptsize\ifnum\sidecount<100 0\fi\number\sidecount}%
    \advance\sidecount by -52
    \advance\sidecount by 1
    \advance\siderulery by 12pt
  \ifnum\sidecount<53
  \repeat
}
