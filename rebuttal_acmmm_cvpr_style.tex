...
\vspace{-0.35em}
{\scriptsize
\noindent\textit{Offset detail.} Original Scout before/overlap/after = 91.3/8.7/0.0\% (4B), 91.3/8.7/0.0\% (8B), 90.5/9.5/0.0\% (32B); median signed gaps = -17.25s/-17.00s/-21.00s. Expanded events raise overlap to 13.5/13.8/15.8\%, suggesting pre-event contextual/precursor evidence rather than random late retrieval.
}
